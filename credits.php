<?php include("head.php"); ?>
    ...
    <ul>
        <li>Patrick De Giovanni, lycée Jean Monnet (Aurillac</li>
        <li>Fabrice Lallemand, lycée Emile Duclaux (Aurillac)</li>     
        <li>Jérôme Mathieu, lycée Jean Monnet (Aurillac)</li>
        <li>Alexandre Rocq, lycée Emile Duclaux (Aurillac)</li>
        <li>Stéphane Sobella, lycée Georges Pompidou (Aurillac)</li>
    </ul>
